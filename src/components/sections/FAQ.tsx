	...
	return (
		<section id="faq" className="py-16 md:py-24 bg-background-secondary">
			<div className="container-custom max-w-4xl">
				...
				>
					<h2 className="font-serif mb-2 text-charcoal">
						{faq.title}
					</h2>
						...
						return (
							...
							>
								...
								>
									...
									>
										<FaChevronDown className="text-charcoal" />
									</motion.div>
								</button>
								...
								>
									<div className="px-6 pb-4 text-charcoal">
										{item.answer}
									</div>
								</motion.div>
							</motion.div>
				...
				>
					...
					<p className="text-charcoal mb-6">{faq.contact.message}</p>
					<a
						href={`mailto:${contactEmail}`}
						className="inline-flex items-center text-charcoal hover:underline"
					>
