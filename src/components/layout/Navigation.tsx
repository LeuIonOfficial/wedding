...
import { getCoupleNames } from "@/lib/utils";
			...
			>
				...
				>
					<Link
						...
						className="text-xl font-cursive tracking-wide z-50 text-charcoal"
					>
						{getCoupleNames()}
					</Link>
					{/* Desktop Navigation */}
										...
										{menuItems.map((item) => (
											...
											>
												<Link
													...
													className="text-xl font-serif hover:text-charcoal transition-colors duration-300"
													onClick={() =>
														setIsOpen(false)
													}
												>
